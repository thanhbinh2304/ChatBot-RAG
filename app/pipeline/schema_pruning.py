...
Employee(employeeId [PK], employeeCode, positionId [FK -> Position.positionId], note, status[Boolean: True=Hoạt động, False=Không hoạt động], hireDate, createdAt, updatedAt, gender, dateOfBirth, phoneNumber, fullName, email, wardId) -- Nhân viên / Người làm
